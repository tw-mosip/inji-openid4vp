...
data class UnsignedMdocVPToken(
    ...
    companion object Builder {
        fun build(
            mdocCredentials: List<String>,
            clientId: String,
            responseUri: String,
            verifierNonce: String,
            mdocGeneratedNonce: String
        ): UnsignedMdocVPToken {
            val unsignedDeviceAuth = mutableMapOf<String, Any>()
            ...
            mdocCredentials.map { mdocCredential ->
                ...
                unsignedDeviceAuth[docType] = mapOf(
                    "payload" to encodeCbor(deviceAuthenticationBytes).toHex(),
                )
            }
