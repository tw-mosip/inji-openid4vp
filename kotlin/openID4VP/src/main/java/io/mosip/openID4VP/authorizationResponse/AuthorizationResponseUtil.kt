...
import io.mosip.openID4VP.authorizationResponse.jwe.JWEHandler
...
fun createAuthorizationResponseBody(
    ...
    val encodedPresentationSubmission = encode(presentationSubmission, "presentation_submission") // TODO: should not be stringified
    ...
    return when (authorizationRequest.responseMode) {
        ...
        DIRECT_POST_JWT.value -> {
            val encryptedBody = JWEHandler(clientMetadata).createResponse(bodyParams)
