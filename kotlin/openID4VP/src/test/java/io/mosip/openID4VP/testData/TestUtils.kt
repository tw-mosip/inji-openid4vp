...
fun createUrlEncodedData(
    ...
    authorizationRequestParam = if(verifierSentAuthRequestByReference != true  && isPresentationDefinitionUriPresent != true)
        authorizationRequestParam + clientMetadataPresentationDefinitionString
    else if(verifierSentAuthRequestByReference != true )
        authorizationRequestParam + mapOf(
